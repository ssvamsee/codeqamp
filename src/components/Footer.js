    ...
    <footer className="bg-gray-800 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold mb-4 text-primary">CodeQamp</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {legalLinks.map((link, index) => (
                <li key={index}>
                  <a href={link.to} className="text-gray-300 hover:text-primary transition-colors">
                    {link.name}
                  </a>
                </li>
              ))}
      ...
      <div className="bg-gray-900 py-4">
        <div className="container mx-auto px-4 text-center text-gray-300 text-sm">
          <p>© {currentYear} CodeQamp. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
